...
SELECT name FROM tvshow WHERE genre = 'drama'; 
...
-- Returns all the tv shows that have more than 1 season. --
SELECT distinct name, seasons FROM tvshow WHERE seasons >1;
